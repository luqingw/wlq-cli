...
const name = defaultSettings.title || 'MESH' // page title

// If your port is set to 80,
// use administrator privileges to execute the command line.
// For example, Mac: sudo npm run
// You can change the port by the following method:
// port = 7077 npm run dev OR npm run dev --port = 7077
const port = process.env.port || process.env.npm_config_port || 7077 // dev port
  ...
  chainWebpack(config) {
    ...
    config.when(process.env.NODE_ENV !== 'development', (config) => {
      ...
      config.optimization.splitChunks({
        ...
        //   elementUI: {
        //     name: 'chunk-daoUI', // split elementUI into a single package
        //     priority: 20, // the weight needs to be larger than libs and app or it will be packaged into libs or app
        //     test: /[\\/]node_modules[\\/]_?dao-ui(.*)/ // in order to adapt to cnpm
        //   },
          commons: {
            name: 'chunk-commons',
